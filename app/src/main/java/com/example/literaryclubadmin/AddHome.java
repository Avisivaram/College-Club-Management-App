...
public class AddHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mData=mfDatabase.getReference().child("Home");

        mfStorage=FirebaseStorage.getInstance();
        storageReferencee=mfStorage.getReference().child("Home");
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((!ed1.getText().toString().trim().equals("")) && (!ed2.getText().toString().trim().equals("")) && mUri!=null){
                    s1=getFileExtension(mUri);
                    s2=ed1.getText().toString();
                    s3=ed2.getText().toString();
                    mData=mfDatabase.getReference("Home").child(s2);
                    storageReferencee=mfStorage.getReference("Home").child(s2);
                    ...
                    UploadTask uploadTask= (UploadTask) storageReferencee
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            mData=mfDatabase.getReference("Home/"+s2+"/");
                            mData.child("Description").setValue(s3);
                            mData.child("Event").setValue(s2);
                            mData.child("Like").setValue(0);
                        }
