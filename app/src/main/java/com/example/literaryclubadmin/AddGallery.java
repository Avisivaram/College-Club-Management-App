...
public class AddGallery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed1=findViewById(R.id.Comment);
        img1=findViewById(R.id.testImage);

        mfDatabase=FirebaseDatabase.getInstance();
        mData=mfDatabase.getReference().child("Gallery");

        mfStorage=FirebaseStorage.getInstance();
        storageReferencee=mfStorage.getReference().child("Gallery");
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((!ed1.getText().toString().trim().equals("")) && mUri != null) {
                    s1 = getFileExtension(mUri);
                    s2 = ed1.getText().toString();

                    mData = mfDatabase.getReference("Gallery").child(s2);
                    storageReferencee = mfStorage.getReference("Gallery").child(s2);
                    ...
                    UploadTask uploadTask= (UploadTask) storageReferencee
                            .putFile(mUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    mData=mfDatabase.getReference("Gallery/"+s2+"/");
                                    mData.child("Comments").setValue(s2);
                                }
